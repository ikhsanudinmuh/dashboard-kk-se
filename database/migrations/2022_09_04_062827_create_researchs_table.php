...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('researchs', function (Blueprint $table) {
            $table->increments('id');
            $table->text('year');
            $table->integer('research_type_id')->unsigned()->nullable();
            ...
            $table->text('research_file')->nullable();
            $table->timestamps();

            $table->foreign('research_type_id')->references('id')->on('research_types')->onDelete('set null');
